...
class HashTag(models.Model):
    ...
    def get_absolute_url(self):
    	return reverse_lazy("hashtag", kwargs={"hashtag": self.tag}) # for reverse calling the url

    def get_tweets(self):
        return Tweet.objects.filter(content__icontains="#" + self.tag) #get the tweets filtered by hashtags


#custom signal function for hashtag parsing and recieving
